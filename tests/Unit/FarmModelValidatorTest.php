...
T0 ; slot chosen by matplace farm
", GcodeSlot::retarget($gcode, 0), 'slot 1 gets its tool line too');
...
M106 P3 S153
G90
", GcodeSlot::retarget($orca, 0), 'the firmware refuses a file without a tool line');
    }
...
M104 S0 ; turn off temperature", $out, 'switching the heaters off stays');
        $this->assertSame(str_replace("M117
", "M117
T0 ; slot chosen by matplace farm
", $g), GcodeSlot::retarget($g, 0), 'slot 0 and no temperatures: only the tool line');
