...
/opt/matplace-py/bin/pip install -q trimesh numpy scipy networkx pymeshfix pillow manifold3d lxml svgelements segno fonttools scikit-image || /opt/matplace-py/bin/pip install -q trimesh numpy pillow
