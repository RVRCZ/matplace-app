...
<div class="mx-auto max-w-2xl">
    ...
    <form id="relief-form" class="mt-5 space-y-4 rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <label class="block cursor-pointer rounded-2xl border-2 border-dashed border-slate-300 p-5 text-center hover:border-teal-500">
        ...
        <label class="block text-sm font-semibold">{{ __('relief.width') }} <span id="relief-w-val" class="font-normal text-teal-700">100 mm</span>
            <input id="relief-w" name="width" type="range" min="40" max="200" step="5" value="100" class="mt-1 w-full accent-teal-600">
        </label>
        ...
        <button class="w-full rounded-xl bg-teal-600 px-4 py-3 font-semibold text-white disabled:opacity-60">{{ __('relief.submit') }}</button>
