...
<div class="mx-auto max-w-4xl">
    ...
    <div class="mt-5 flex items-center justify-between">
        ...
        <form method="post" action="{{ route('printer.quotes.store') }}">@csrf<button class="rounded-full bg-action px-4 py-2 text-sm font-semibold text-white">+ {{ __('quote.new_empty') }}</button></form>
    </div>
