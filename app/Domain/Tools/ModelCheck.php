...
final class ModelCheck
{
    ...
    public static function report(ModelFile $file): array
    {
        ...
        $intended = ! empty($file->tool_params['stand']) || in_array($file->kind(), ['box', 'vase', 'stamp', 'qr', 'logo', 'lightbox', 'modular', 'sign'], true);   // our own multi-part products are several bodies by design
